import 'dart:io';
import 'downloader.dart'; // Asumsi nama file untuk class Downloader
import 'html_parser.dart'; // Asumsi nama file untuk class HtmlParser
...
class ImageGrabber {
  ...
  Future<void> run() async {
    ...
    // Perbaikan: Menambahkan variabel 'url' sebagai argumen fungsi
